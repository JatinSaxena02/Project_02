...
urlpatterns = [
    ...
    path('instruction', UserRegistration.Instruction),
    path('checkotp', UserRegistration.ChkOtp),
    path('checkemailsignpage',UserRegistration.CheckEmailSignPage),
    path('questionpage/', UserRegistration.QuestionPage),
    path('callquestionpage', UserRegistration.CallQuestionPage),
    path('submitscore/', UserRegistration.SubmitScore),
    path('doctorlogin/', UserRegistration.DoctorLogin),
    path('doctorlogindashboard', UserRegistration.DoctorLoginDashboard),
    path('doctorlogout', UserRegistration.DoctorLogout),
